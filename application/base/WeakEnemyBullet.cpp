...
//初期化
void WeakEnemyBullet::Initialize(Model* model, Object3d* obj, const XMFLOAT3& position, const XMFLOAT3& velocity) {
...
void WeakEnemyBullet::Reset() { isDead_ = true; }

//更新
void WeakEnemyBullet::Update() {
	//座標を移動させる
...
//描画
void WeakEnemyBullet::Draw() {
	//モデル描画
	obj_->Draw();
}

//衝突を検出したら呼び出されるコールバック関数
void WeakEnemyBullet::OnCollision() { isDead_ = true; }

//ワールド座標を取得
XMFLOAT3 WeakEnemyBullet::GetWorldPosition() {
